...
class Basic_Clean_Warp_IFBlock(nn.Module):
...
class Clean_Warp_IFNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.block0 = Basic_Clean_Warp_IFBlock(6, c=90)
        self.block1 = Basic_Clean_Warp_IFBlock(15 + 4, c=90)
        self.block2 = Basic_Clean_Warp_IFBlock(15 + 4, c=90)
        self.block_tea = Basic_Clean_Warp_IFBlock(18 + 4, c=90)
    ...
    def forward(self, x, scale=[4, 2, 1], timestep=0.5):
        ...
        for i in range(3):
            ...
            warped_img0 = mask_clean_mask_0 * warped_img0 + (1 - mask_clean_mask_0) * img1 # Clean warped image0
            warped_img1 = mask_clean_mask_1 * warped_img1 + (1 - mask_clean_mask_1) * img0 # Clean warped image1
        ...
        if gt.shape[1] == 3:
            ...
            merged_teacher = None
        for i in range(3):
            # still use "mask" to merge two clean warped image
